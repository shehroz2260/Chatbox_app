...
class ApiController extends GetxController {
  ...
  void pickImage() async {
    ...
    if (res != null) {
      ...
      result = "";
      update();
      performOcr(File(res.path));
    }
  }

  Future<void> performOcr(File imagePath) async {
    BaseController.showProgress();
    try {
      const String url =
          "https://app.nanonets.com/api/v2/OCR/Model/785cb822-c17d-40b4-865d-dd75da364ffc/LabelFile/?async=false";
